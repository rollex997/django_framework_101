...
urlpatterns = [
    ...
    #using celery worker for sending email
    path('send_PDF_via_Email_using_celery/',send_PDF_via_Email_using_celery.as_view(),name="send_PDF_via_Email_using_celery"),
]

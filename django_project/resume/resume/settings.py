...
#This is for storing user uploaded media files into the media folder in static folder in root directory
...
SECRET_KEY = 'django-insecure-m@z*&$epm)m&45ebj+!%sr%=$-ah2--#_#tq*ph^a8$3w+jt04'

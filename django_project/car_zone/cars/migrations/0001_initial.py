# Generated by Django 4.2.8 on 2024-02-27 08:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_photo_1', models.ImageField(blank=True, upload_to='photos/cars_1/%Y/%m/%d/')),
                ('car_photo_2', models.ImageField(blank=True, upload_to='photos/cars_2/%Y/%m/%d/')),
                ('car_photo_3', models.ImageField(blank=True, upload_to='photos/cars_3/%Y/%m/%d/')),
                ('car_photo_4', models.ImageField(blank=True, upload_to='photos/cars_4/%Y/%m/%d/')),
